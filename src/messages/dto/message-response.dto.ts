...
export class UserInfoDto {
  ...
  @ApiProperty({ description: 'Tipo de usuario', enum: ['POSTULANTE', 'EMPRESA'] })
  userType: string;
...
export class MessageResponseDto {
  ...
  @ApiProperty({ description: 'Información del usuario remitente', type: UserInfoDto, required: false })
  fromUser?: UserInfoDto;

  @ApiProperty({ description: 'Información del usuario destinatario', type: UserInfoDto, required: false })
  toUser?: UserInfoDto;
}

export class ConversationResponseDto {
  @ApiProperty({ description: 'Información del usuario con quien se conversa', type: UserInfoDto })
  user: UserInfoDto;

  @ApiProperty({ description: 'Último mensaje de la conversación', type: MessageResponseDto })
